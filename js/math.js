...
class M3x3 {
	...
	multiply(m) {
		...
		output.matrix = [
			...
			this.matrix[M3x3.M00] * m.matrix[M3x3.M10] + this.matrix[M3x3.M10] * m.matrix[M3x3.M10] + this.matrix[M3x3.M20] * m.matrix[M3x3.M12],
...
// values to access row,col of matrix 
// M00 : M(row)(col)
M3x3.M00 = 0;
M3x3.M01 = 1;
M3x3.M02 = 2;
